<?php
$a="SELECT id_tip, tipo from tip ORDER BY id_tip";
...
?>
<?php
$t="SELECT id_mpr, model from mod_produ ORDER BY model";
//include('conexion.php');
$j=$con->query($t);
//$w=$j->fetch_assoc();
...
<header class="p-3 text-bg-dark">
    ...
    <form action="subir.php" method="post" enctype="multipart/form-data">
        <h4 class="mb-3">agregar partes de auto</h4>
        <form class="needs-validation" novalidate>
            ...
            <br>    
              ...
              tipo de parte
            <select name="tip">
                <option value = "0">elegi un tipo de parte</option>
                <?php
             while($o=$h->fetch_assoc()) {
                echo "<option value='".$o["id_tip"]."'>".$o["tipo"]."</option>";
             }
            ?>
            </select>
            </div>
            ...
            ingrese el modelo
              ...
              <?php
              while($w=$j->fetch_assoc()) {
                echo "<option value='".$w["id_mpr"]."'>".$w["model"]."</option>";
              }
              ?>  
               </div>
